...
public class Block {
	...
	public String toString() {
		return String.format("%s Block of type %s", shot ? "Shot" : "Not shot", type);
	}

	public static enum BlockType {
		WATER(' ', -1, -1, "water"), CRUISER('C', 6, 1, "cruiser"), BATTLESHIP('B', 4, 2, "battleship"),
		SUBMARINE('S', 3, 3, "submarine"), PATROL_BOAT('P', 2, 4, "patrol boat");
